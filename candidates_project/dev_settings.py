"""
Django settings for candidates_project project.
...
SECRET_KEY = os.environ.setdefault('SECRET_KEY', 'Dummy Secret Key')
...
ROOT_URLCONF = 'candidates_project.urls'
...
WSGI_APPLICATION = 'candidates_project.wsgi.application'
